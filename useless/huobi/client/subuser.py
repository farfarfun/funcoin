...
from funcoin.huobi.utils.input_checker import check_in_list, check_should_not_none
...
class SubuserClient(object):
    ...
    def post_set_tradable_market(
        ...
        check_in_list(
            account_type,
            [SubuserTradePrivilegeType.MARGIN, SubuserTradePrivilegeType.SUPER_MARGIN],
            "accountType",
        )
        check_in_list(
            activation,
    ...
    def post_subuser_apikey_generate(
        self,
        otp_token: "str",
        sub_uid: "int",
        note: "str",
    ...
    def get_user_apikey_info(self, uid: "str", access_key: "str" = None):
        ...
        params = {"uid": uid, "accessKey": access_key}
        channel = "/v2/user/api-key"
        return self.rest_api_sync_client.request_process(
            HttpMethod.POST_SIGN, channel, params
        )

    def post_subuser_apikey_modification(
        self,
        sub_uid: "str",
        access_key: "str",
        note: "str" = None,
    ...
    def post_subuser_apikey_deletion(self, sub_uid: "str", access_key: "str"):
        ...
        params = {"subUid": sub_uid, "accessKey": access_key}
