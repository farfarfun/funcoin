...
from darkcoins.huobi.client import GenericClient
from darkcoins.huobi.strategy.message import HuoBiMessage
from darkcoins.huobi.strategy.trade_order import TradeOrder
...
# nohup /root/anaconda3/bin/python3.8 /root/workspace/darkchats/darkcoins/darkcoins/huobi/strategy/check_new.py >>/root/workspace/tmp/darkcoins-check-run-$(date +%Y-%m-%d).log 2>&1 &
