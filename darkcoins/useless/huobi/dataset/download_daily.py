...
import pandas as pd
from darkcoins.huobi.history.core import ALL_PERIODS, ALL_TYPES, load_daily_all
...
def save_kline_to_odps(start_date=datetime(2021, 1, 1), end_date=datetime(2021, 5, 31)):
    t = opt.get_table("ods_darkcoin_huobi_klines_data_d")
...
def save_trade_to_odps(start_date=datetime(2021, 1, 1), end_date=datetime(2021, 5, 31)):
    t = opt.get_table("ods_darkcoin_huobi_trades_data_d")
