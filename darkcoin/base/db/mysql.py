...
class create_conn(object):
    ...
    def __enter__(self):
        self.instance = pymysql.connect(
            host=read_secret(cate1='darkcoin', cate2='dataset', cate3='mysql', cate4='host'),
            user=read_secret(cate1='darkcoin', cate2='dataset', cate3='mysql', cate4='user'),
            password=read_secret(cate1='darkcoin', cate2='dataset', cate3='mysql', cate4='password'),
...
def _get_uri(key=None):
    host = read_secret(cate1='darkcoin', cate2='dataset', cate3='mysql', cate4='host')
    port = read_secret(cate1='darkcoin', cate2='dataset', cate3='mysql', cate4='port') or '3306'
    user = read_secret(cate1='darkcoin', cate2='dataset', cate3='mysql', cate4='user')
    password = read_secret(cate1='darkcoin', cate2='dataset', cate3='mysql', cate4='password')
    db_name = 'darkcoin' if key is None or len(key) == 0 else f'darkcoin_{key.lower()}'
