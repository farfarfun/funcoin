...
from darkcoin.huobi.client import GenericClient
from darkcoin.huobi.strategy.message import HuoBiMessage
from darkcoin.huobi.strategy.trade_order import TradeOrder
...
# nohup /root/anaconda3/bin/python3.8 /root/workspace/darkchats/darkcoin/darkcoin/huobi/strategy/check_new.py >>/root/workspace/tmp/darkcoin-check-run-$(date +%Y-%m-%d).log 2>&1 &
